...
public class Notepad extends JFrame {
	...
	private JMenuItem neW, opeN, savE, saveAS, prinT, exiT, fonT, abouT, cuT, copY, pastE, selectALL;
	...
	public Notepad() {
		...
		/**
		 * adding neW, opeN, savE, saveAS, prinT & exiT to the filE Menu, adding a small
		 * image icon to the menu item & adding separator between the menu item
		 */
		 ...
		 * Menu, adding a small image icon to the menu item & adding separator between
		 * the menu item
		 */
		...
		/**
		 * adding lineWraP & fonT to the formaT Menu, adding abouT to the helP Menu &
		...
		/**
		 * allowing the file menu to be selected by pressing ALT + F allowing the edit
		 * menu to be selected by pressing ALT + E allowing the view menu to be selected
		 * by pressing ALT + V allowing the format menu to be selected by pressing ALT +
		 * O allowing the help menu to be selected by pressing ALT + H
		 */
		filE.setMnemonic('f');
		ediT.setMnemonic('e');
		vieW.setMnemonic('v');
		...
		/**
		 * allowing the neW menu item to be selected by pressing ALT + N allowing the
		 * opeN menu item to be selected by pressing ALT + O allowing the savE menu item
		 * to be selected by pressing ALT + S allowing the prinT menu item to be
		 * selected by pressing ALT + P allowing the exiT menu item to be selected by
		 * pressing ALT + F4 allowing the cuT menu item to be selected by pressing ALT +
		 * X allowing the copY menu item to be selected by pressing ALT + C allowing the
		 * pastE menu item to be selected by pressing ALT + V allowing the selectAll
		 * menu item to be selected by pressing ALT + A
		 */
		 ...
		 * abouT the actions was written @Actions.java
		 */
		 ...
		 * aboutButton the actions was written @Actions.java
		 */
		...
		/**
		 * allowing the finD menu item to be selected by pressing ALT + F allowing the
		 * findNexT menu item to be selected by pressing ALT + F3
		 */
