 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.webots.mydsl.myDsl.impl.ActuatorImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActuatorImpl extends MinimalEObjectImpl.Container implements Actuator
{
  ...
  public void setName(String newName)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ACTUATOR__NAME, oldName, name));
	}
  ...
  {
		switch (featureID) {
			case MyDslPackage.ACTUATOR__NAME:
				return getName();
		}
