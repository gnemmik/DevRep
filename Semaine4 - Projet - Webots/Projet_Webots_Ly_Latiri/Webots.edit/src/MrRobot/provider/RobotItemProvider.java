...
/**
 * This is the item provider adapter for a {@link MrRobot.Robot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RobotItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MrRobotPackage.Literals.ROBOT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MrRobotPackage.Literals.ROBOT__ACTUATORS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MrRobotPackage.Literals.ROBOT__ACTUATORS,
				 MrRobotFactory.eINSTANCE.createLeftMotor()));

		newChildDescriptors.add
			(createChildParameter
				(MrRobotPackage.Literals.ROBOT__ACTUATORS,
				 MrRobotFactory.eINSTANCE.createRightMotor()));
	}
