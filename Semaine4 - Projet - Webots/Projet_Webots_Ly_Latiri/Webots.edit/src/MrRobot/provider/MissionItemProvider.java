...
/**
 * This is the item provider adapter for a {@link MrRobot.Mission} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MissionItemProvider 
	...
	protected void addFinishedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Mission_finished_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Mission_finished_feature", "_UI_Mission_type"),
				 MrRobotPackage.Literals.MISSION__FINISHED,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MrRobotPackage.Literals.MISSION__BEHAVIORS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MrRobotPackage.Literals.MISSION__BEHAVIORS,
				 MrRobotFactory.eINSTANCE.createEscape()));

		newChildDescriptors.add
			(createChildParameter
				(MrRobotPackage.Literals.MISSION__BEHAVIORS,
				 MrRobotFactory.eINSTANCE.createHome()));
	}
